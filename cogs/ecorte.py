...
class ecorte(commands.Cog):
    ...
    @commands.command(hidden=True, aliases=['vc'])
    @commands.cooldown(1, 300, commands.BucketType.user)
    @is_in_guild(324284116021542922)
    async def vraimentcouleur(self, ctx):
        ...
        if role in ctx.author.roles:
            ...
            embed.set_author(name="Vraiment Couleur", icon_url="https://media.discordapp.net/attachments/811959848921071636/822598144968884314/baa392758f065fa770e3a9063f91d33a.png")
            await ctx.send(embed=embed)
        else:
            ctx.send("Tu doit avoir le rôle Vraiment Cool. Pour avoir le rôle tu doit être level 3 sur <@339254240012664832>.")
